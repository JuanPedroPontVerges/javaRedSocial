...
<html lang="en">
    <head>
        ...
        <title>Alta. baja y modificación de Ofertas</title>
                        ...
                        <div class="col-8">
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
                                    <form id="formLogin" method="POST" action="ABMOfertasServlet">
                                        <div class="form-group mt-4">
                                            <label for="usuario">Titulo</label>
                                            <input type="text" class="form-control" id="usuario" name="titulo">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="usuario" name="precio">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleFormControlSelect2">Comercio</label>
                                            <select class="form-control" id="exampleFormControlSelect2" name="idComercio">
                                                <c:forEach items="${gestor.comercios}" var="comercio">
                                                    <option value="${comercio.id}">${comercio.nombre}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                        <button type="submit" class="btn btn-primary" name="opcion" value="crear">Crear Oferta</button>
                                    ...
                                    <form id="formLogin" method="POST" action="ModificacionServlet">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="idOferta">
                                                <c:forEach items="${gestor.ofertas}" var="o">
                                                    <option value="${o.id_oferta}">${o.titulo}</option>
                                                </c:forEach> 
                                            </select>
                                        </div>
                                ...
                                <div class="tab-pane fade" id="list-messages" role="tabpanel" aria-labelledby="list-messages-list">
                                    <form id="formLogin" method="POST" action="ABMOfertasServlet">
                                        <h5>Ofertas</h5>
                                        <select class="form-control" id="exampleFormControlSelect2" name="idOferta">
                                            <c:forEach items="${gestor.ofertas}" var="oferta">
                                                <option value="${oferta.id_oferta}">${oferta}</option>
                                            </c:forEach> 
                                        </select>
